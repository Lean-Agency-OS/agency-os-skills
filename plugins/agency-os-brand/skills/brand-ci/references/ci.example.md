...
colors:
  ...
  subtitle: "#FED760"     # Untertitel-Füllfarbe (video-shortform --caption-color)
fonts:
...
- **video-shortform:** Modell liest das Frontmatter und übergibt z.B. `--caption-color {colors.subtitle}`,
