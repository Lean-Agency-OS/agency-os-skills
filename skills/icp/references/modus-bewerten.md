...
## Teil A: Analytische Bewertung (5 Dimensionen)
...
**2. Emotionale Resonanz: Triggert es eine der dokumentierten Spannungen?**
Die stärksten Reaktionen entstehen, wenn eine der emotionalen Spannungen aus dem Profil aktiviert wird. Der ICP muss sich ertappt fühlen, nicht belehrt.

Prüffrage: Löst es eine emotionale Reaktion aus (Widerspruch, Identifikation, Neugier, Betroffenheit) oder bleibt es rational-distanziert?

**3. Identität: Spricht es die Wunschidentität an?**
Die Wunschidentität steht im Profil. Alles, was die Identitätsverschiebung dorthin unterstützt, hat Pull. Alles, was den ICP in seiner aktuellen Rolle bestätigt, hält ihn fest.

Prüffrage: Bewegt es den ICP Richtung Wunschidentität oder bestätigt es den Ist-Zustand?
...
Prüffrage: Würde er scrollen oder stoppen?
...
> **[Name], [Alter], [Firmen-Typ] [Stadt], [Situation]:**
>
...
## Spezial-Checks nach Typ

### Content-Ideen (Posts, Newsletter, Videos)
- Diagnostiziert die Idee ein Problem oder lehrt sie eine Lösung? (Diagnose > Lehre)
- Ist die gewünschte Reaktion "Das ist meine Firma" oder nur "Guter Tipp"?

### Angebotsnamen / Framework-Namen
- Trägt der Name das Ergebnis oder den Prozess? (Ergebnis ist stärker)
- Verwendet er ICP-Sprache aus dem Profil oder generische Business-Sprache?
- Transportiert er Status/Identität in Richtung der Wunschidentität?

### Ads / Paid Copy
- Stoppt es den Scroll in unter 2 Sekunden?
- Spricht es ein spezifisches Symptom an, nicht ein abstraktes Problem?
- Ist der CTA so konkret, dass der ICP sofort weiß, was beim Klick passiert?

### Landing Pages / Offer-Copy
- Ist der Held der Story der ICP, nicht die Agentur?
- Werden seine echten Einwände adressiert?
- Ist das Versprechen spezifisch genug, um geglaubt zu werden?
